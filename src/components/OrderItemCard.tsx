...
const OrderItemCard = ({ order }: Props) => {
    ...
    //initially we'll set the default status of the order which we get from the database 
    ...
    <Card>
        ...
        <CardContent className="flex flex-col gap-6">
            ...
            <div className="flex flex-col space-y-2">
                ...
                <Select 
                //the select component will also have the status which we get from the database by default and onChange it will change the status
                    value={status}
                    disabled={isLoading} 
